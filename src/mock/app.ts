module.exports = [
    ...
    },
    {
        ...
        result:{
            'data':{
                'orgs':[
                    {'autoId':1,'name':'Google','desc':'@csentence(6, 10)',parentId:0},
                    {'autoId':2,'name':'FaceBook','desc':'@csentence(6, 10)',parentId:1},
                    {'autoId':3,'name':'MicroSoft','desc':'@csentence(6, 10)',parentId:1},
                    {'autoId':4,'name':'Amazon','desc':'@csentence(6, 10)',parentId:3},
                    {'autoId':5,'name':'Apple','desc':'@csentence(6, 10)',parentId:3}
                ],
                'staff':[
